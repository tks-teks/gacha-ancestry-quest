...
export const heritageObjects: HeritageObject[] = [
  {
    ...
    extendedKnowledge: {
      ...
      techniques: `La construction d'une case obus nécessite entre 2 et 6 mois de travail collectif. Le matériau principal est le "banco", un mélange de terre argileuse, de paille, de bouse de vache et d'eau, préparé et laissé à fermenter plusieurs jours. La construction se fait par anneaux successifs de 40 à 60 cm de hauteur. Chaque anneau doit sécher 2-3 jours avant d'ajouter le suivant. Les nervures (appelées "tobol") sont formées en ajoutant des boudins de terre tous les 30 cm environ. Elles servent de marches pour les artisans et de canaux d'évacuation des eaux de pluie. Le sommet est scellé par une "clé de voûte" en terre, parfois ornée d'un pot retourné. L'intérieur est enduit d'un mélange de bouse et de terre lissé à la main. Le sol est en terre battue, surélevé pour éviter les infiltrations.`,
      culturalSignificance: `La case obus est bien plus qu'un abri : elle représente l'identité du peuple Mousgoum. Chaque famille possède un ensemble de cases formant une concession (saré) : une grande case pour le chef de famille, des cases plus petites pour les épouses, une case-cuisine, et des greniers à mil de forme similaire mais plus petits. La taille et le nombre de cases indiquent le statut social de la famille. La construction est un événement communautaire où tout le village participe, renforçant les liens sociaux. Les cases sont traditionnellement orientées avec l'entrée vers l'est, vers le soleil levant.`,
